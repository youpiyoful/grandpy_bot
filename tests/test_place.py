...
def mock_response_wrong(monkeypatch):
    ...
    monkeypatch.setattr(requests, "get", mock_requests_get_when_data_is_not_found)
...
def test_build_url_for_api_place():
    ...
    f"=textquery&fields=formatted_address,name,geometry&key={DEFAULT_CONFIG['google_api_key']}"
