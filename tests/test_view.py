...
def mock_request_args_is_ok(monkeypatch):
    ...
    monkeypatch.setattr(view.request, "args.get", mock_request_args)


# @pytest.fixture
# def mock_request_args_is_ok():

#     def mock_request_args():
#         with app.test_client() as c:
#             rv = c.get('?answers=openclassrooms')
#             return rv
...
def test_get_data_if_any_keyword(
    mock_response_find_place_is_ok,
    mock_response_find_data_about_place_is_ok,
    mock_request_args_is_ok,
    monkeypatch,
